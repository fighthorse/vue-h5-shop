...
-- ----------------------------
-- Table structure for vue_banner
-- ----------------------------
DROP TABLE IF EXISTS `vue_banner`;
CREATE TABLE `vue_banner` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `url` varchar(255) DEFAULT NULL,
  `imgurl` varchar(255) DEFAULT NULL,
  `status` tinyint(1) DEFAULT '1' COMMENT '状态 1 正常',
  `sort` int(11) DEFAULT '9999' COMMENT '排序 asc',
  `add_time` datetime DEFAULT NULL,
  `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='首页轮播图配置';

-- ----------------------------
-- Records of vue_banner
-- ----------------------------

-- ----------------------------
-- Table structure for vue_friend_link
-- ----------------------------
DROP TABLE IF EXISTS `vue_friend_link`;
CREATE TABLE `vue_friend_link` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `url` varchar(255) DEFAULT NULL,
  `icons` varchar(255) DEFAULT NULL,
  `sort` int(11) DEFAULT '9999' COMMENT '排序 asc ',
  `status` tinyint(1) DEFAULT '1' COMMENT '是否可用 1 是，0 否',
  `add_time` datetime DEFAULT NULL,
  `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Records of vue_friend_link
-- ----------------------------

-- ----------------------------
-- Table structure for vue_home_page
-- ----------------------------
DROP TABLE IF EXISTS `vue_home_page`;
CREATE TABLE `vue_home_page` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` char(64) DEFAULT NULL COMMENT '模块名称',
  `url` varchar(255) DEFAULT NULL COMMENT '链接',
  `icons` varchar(255) DEFAULT NULL COMMENT '图标',
  `status` tinyint(1) DEFAULT '1' COMMENT '是否可用 1是，0否',
  `fontcolor` varchar(255) DEFAULT NULL COMMENT '字体颜色',
  `bgcolor` varchar(255) DEFAULT NULL COMMENT '背景颜色 #16或者其他',
  `sort` int(11) DEFAULT '9999' COMMENT '排序 asc',
  `add_time` datetime DEFAULT NULL,
  `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='首页模块配置';

-- ----------------------------
-- Records of vue_home_page
-- ----------------------------
